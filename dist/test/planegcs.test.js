...
describe("planegcs", () => {
    ...
    it("constraint with a line can be called with a line object", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it("can add B-spline", () => {
        ...
        const b_spline = gcs.make_bspline(0, 1, 6, 7, arr_to_intvec(gcs_factory, control_point_is), arr_to_intvec(gcs_factory, weight_is), arr_to_intvec(gcs_factory, knot_is), arr_to_intvec(gcs_factory, multiplicities), degree, periodic);
